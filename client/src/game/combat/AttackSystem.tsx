...
// Note: canCardAttack is imported from attackUtils, but other functions are defined locally
import { canCardAttack as canCardAttackUtil } from './attackUtils';
...
export function canCardAttack(card: CardInstance, isPlayerTurn: boolean): boolean {
  ...
  if (card.isSummoningSick) {
    // Cards with Charge or Rush ignore summoning sickness
  ...
  // Check for maximum attacks per turn (1 by default, 2 for Windfury)
