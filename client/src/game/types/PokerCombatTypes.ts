...
/**
 * Elemental types for pets - imported from ChessTypes for consistency
 */
import { ElementType, ELEMENT_STRENGTHS, getElementAdvantage, ELEMENT_COLORS, ELEMENT_ICONS } from './ChessTypes';
...
export interface CombatResolution {
  ...
  foldPenalty?: number; // Damage taken by folder (3 HP)
  whoFolded?: 'player' | 'opponent'; // Who folded
}
