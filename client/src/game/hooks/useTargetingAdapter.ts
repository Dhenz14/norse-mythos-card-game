...
export function useTargetingAdapter(): TargetingAdapter {
  ...
  return {
    isTargeting: legacy.isTargeting,
    attackerId: legacy.attackerId,
    validTargets: legacy.validTargets,
    hoveredTargetId: legacy.hoveredTargetId,
    startTargeting: legacy.startTargeting,
    updateHoveredTarget: (targetId: string | null) => legacy.updateHoveredTarget(targetId),
    cancelTargeting: legacy.cancelTargeting,
    confirmTarget: legacy.confirmTarget,
  };
}
