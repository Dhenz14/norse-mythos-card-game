...
export const QUEST_POOL: QuestTemplate[] = [
	...
	{ type: 'play_legendary', title: 'Summon the Aesir', description: 'Play {goal} legendary cards', goal: 2, reward: { rune: 35, xp: 50 } },
	{ type: 'play_legendary', title: 'Pantheon Assembled', description: 'Play {goal} legendary cards', goal: 4, reward: { rune: 60, xp: 80 } },
