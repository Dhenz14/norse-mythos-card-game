...
export const EGYPTIAN_HEROES: Record<string, NorseHero> = {
	...
	'hero-khepri': {
		...
		weakness: 'dark',
		startingHealth: 100,
		description: 'The scarab-headed god reborn as a hunter of demons, consuming enemy souls to fuel his burning radiance.',
		lore: 'Each morning Khepri rolls the newborn sun across the horizon. But when the demons of the Duat spilled forth, Khepri turned his solar fire inward — burning away his gentle nature to become a weapon of blinding wrath. Now the scarab devours darkness itself.',
		gender: 'male',
		hasSpells: true,
		fixedCardIds: [],
