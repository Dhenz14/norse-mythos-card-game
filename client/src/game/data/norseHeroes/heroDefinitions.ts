...
export const NORSE_HEROES: Record<string, NorseHero> = {
  ...
  'hero-loki': {
    ...
    hasSpells: true,
    fixedCardIds: [4300], // Fenrir, the Bound Wolf (Loki's child)
    heroPower: {
      id: 'loki-power',
  ...
  'hero-freya': {
    ...
    hasSpells: true,
    fixedCardIds: [4371], // Eikthyrnir, the Stag of Valhalla
    heroPower: {
      id: 'freya-power',
  ...
  'hero-heimdall': {
    ...
    hasSpells: true,
    fixedCardIds: [4394], // Heimdall, Guardian of Bifrost
    heroPower: {
      id: 'heimdall-power',
  ...
  'hero-poseidon': {
    ...
    hasSpells: true,
    heroClass: 'shaman',
    fixedCardIds: [5251, 5252, 5201, 5202, 5221, 5222, 5223, 5224, 5225, 5115],
    heroPower: {
      id: 'poseidon-power',
      name: 'Tidal Wave',
      description: 'Freeze an enemy minion.',
  ...
  'hero-artemis': {
    ...
    hasSpells: true,
    heroClass: 'hunter',
    fixedCardIds: [7102, 7103, 7104, 7105, 7106, 7107, 7108, 7109, 7110, 7200],
    heroPower: {
      id: 'artemis-power',
