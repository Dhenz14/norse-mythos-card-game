...
export const heroSuperMinions: CardData[] = [
  ...
  },
  {
    ...
    flavorText: "Sol rides her chariot ahead of Skoll. One day the wolf will catch her. But not today.",
    keywords: ["battlecry"],
    heroClass: "paladin",
    class: "Paladin",
  ...
  },
  {
    ...
    flavorText: "Hoenir gave sense to Ask and Embla. Without his gift, humanity would be driftwood still.",
    keywords: ["battlecry"],
    heroClass: "priest",
    class: "Priest",
  ...
  },
  {
    ...
    flavorText: "His golden arrows kindle love. His leaden arrows turn hearts to stone. Even Zeus fears his aim.",
    keywords: ["battlecry"],
    heroClass: "priest",
    class: "Priest",
  ...
  },
  {
    ...
    flavorText: "Hera sits upon it, and all of Olympus attends. Her jealousy is legendary, but so is her authority.",
    keywords: ["battlecry"],
    heroClass: "priest",
    class: "Priest",
  ...
  },
  {
    ...
    flavorText: "Aphrodite's will made flesh. No armor deflects it, no distance defeats it.",
    keywords: ["battlecry"],
    heroClass: "priest",
    class: "Priest",
  ...
  },
  {
    ...
    flavorText: "Sigyn holds the bowl above Loki's face, catching the serpent's venom drop by drop. When she turns to empty it, his screams shake the earth.",
    keywords: ["battlecry"],
    heroClass: "druid",
    class: "Druid",
  ...
  },
  {
    ...
    flavorText: "Deep beneath Svartalfheim, the forges never cool. What the dwarves build there reshapes the world above.",
    keywords: ["taunt", "battlecry"],
    heroClass: "druid",
    class: "Druid",
    race: "Elemental",
  ...
  },
  {
    ...
    flavorText: "Tsukuyomi's palace of silver light. Those who enter forget the sun entirely.",
    keywords: ["stealth", "battlecry"],
    heroClass: "rogue",
    class: "Rogue",
  ...
  },
  {
    ...
    flavorText: "Sarutahiko guards where paths diverge. All travelers must choose, and none may pass unchallenged.",
