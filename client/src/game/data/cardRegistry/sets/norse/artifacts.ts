...
const norseArtifacts: ArtifactCardData[] = [
	...
	},
	{
		...
		heroId: 'hero-kvasir',
		attack: 0,
		description: 'After you cast a spell, Discover a spell from any class. End of turn: if you cast 3+ spells this turn, draw 2 cards.',
	...
	},
	{
		...
		heroId: 'hero-blainn',
		attack: 0,
		description: 'After you play a minion: +1/+1 if it costs 3 or less, or +0/+3 if it costs 4+. Once per game: transform a minion into a random Legendary.',
		...
		artifactEffect: {
			...
			oncePerGame: { transformToLegendary: true }
		},
		categories: ['norse_artifact']
	},
	...
	},
	{
		...
		heroId: 'hero-aegir',
		attack: 0,
		description: 'End of turn: Discover a minion that costs (2) less. If your hand is empty, draw 3 cards instead.',
