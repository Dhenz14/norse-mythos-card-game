...
const paladinTokens: CardData[] = [
  ...
  },
  {
    ...
    flavorText: 'Where it rides, crops wither and wells run dry.',
    type: 'minion',
    rarity: 'rare',
    manaCost: 2,
    attack: 2,
  ...
  },
  {
    ...
    flavorText: 'Its touch brings fever, rot, and ruin.',
    type: 'minion',
    rarity: 'rare',
    manaCost: 2,
    attack: 2,
  ...
  },
  {
    ...
    flavorText: 'Its hoofbeats are drums. Its banner is fire.',
    type: 'minion',
    rarity: 'rare',
    manaCost: 2,
    attack: 2,
  ...
  },
  {
    id: 8508,
    name: 'Rider of Death',
    description: 'A pale horseman in tattered shroud, silence following in its wake.',
    flavorText: 'The pale rider comes last. It always comes last.',
    type: 'minion',
    rarity: 'rare',
    manaCost: 2,
    attack: 2,
