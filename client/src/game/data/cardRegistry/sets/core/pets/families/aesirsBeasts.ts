	...
	// ── Stage 3 (Master) ─────────────────────────────────────────────
	{
		...
		stage3Variants: [
			...
			},
			{
				...
				manaCost: 0,
				keywords: ['charge', 'battlecry'],
				description: 'Charge. Battlecry: Deal 3 damage to all enemy minions.',
			...
			},
			{
				...
				manaCost: 0,
				keywords: ['taunt', 'battlecry'],
				description: 'Taunt. Battlecry: Summon two 2/2 Goats with Charge. Restore 3 Health to all friendly characters.',
