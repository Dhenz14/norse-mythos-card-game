...
export const deathknightCards: CardData[] = [
  {
    ...
    flavorText: "Hel's bargain: take from the living, give to those who already serve her.",
    type: "spell",
    rarity: "common",
    class: "DeathKnight",
    spellEffect: {
  ...
  {
    id: 3005,
    name: "Host of Niflhel",
    manaCost: 6,
    description: "Summon three 2/2 Ghouls with Taunt.",
    flavorText: "From the lowest of the nine realms, the dishonored dead rise at the call of their queen.",
    type: "spell",
    rarity: "rare",
    class: "DeathKnight",
    spellEffect: {
  ...
  },
  {
    ...
    flavorText: "The plague that swept Midgard before Ragnarok. It hollows the living and feeds the dead.",
    type: "spell",
    rarity: "common",
    class: "DeathKnight",
    spellEffect: {
  ...
  {
    id: 3012,
    name: "Helheim Rune-Cutter",
    manaCost: 3,
    attack: 2,
    durability: 3,
    description: "Your weapon has +1 Attack for each Rune you have active.",
    flavorText: "Forged in the cold smithies beneath Niflhel, where the runes are carved into bone, not steel.",
    type: "weapon",
    rarity: "rare",
    class: "DeathKnight",
    collectible: true,
  ...
  {
    id: 3013,
    name: "Niflheim's Carapace",
    manaCost: 4,
    description: "Give your hero +5 Armor and Immunity this turn.",
    flavorText: "Ice grows over the helthegn like a second skin. Steel cannot find what frost has buried.",
    type: "spell",
    rarity: "rare",
    class: "DeathKnight",
    spellEffect: {
  ...
  },
  {
    ...
    flavorText: "Speak the name Hel grants you, and even the living must obey for a moment.",
    type: "spell",
    rarity: "common",
    class: "DeathKnight",
    spellEffect: {
  ...
  },
  {
    ...
    flavorText: "The gate to Hel's hall. To pass through is easy. To make something walk back is the dark art.",
    type: "spell",
    rarity: "rare",
    class: "DeathKnight",
    spellEffect: {
  ...
  {
    id: 3018,
    name: "Bone-Lacquer Ward",
    manaCost: 2,
    description: "Give a minion +2 Health and \"After this minion survives damage, summon a 1/1 Skeleton.\"",
    flavorText: "Each rib of every fallen draugr is bound into the lattice. They protect what they could not in life.",
    type: "spell",
    rarity: "common",
    class: "DeathKnight",
    spellEffect: {
  ...
  {
    id: 3021,
    name: "Draugr's Hunger",
    manaCost: 3,
    description: "Give your hero +4 Armor and Lifesteal this turn.",
    flavorText: "The hungry dead drink. Each wound they deal becomes a wound they no longer carry.",
    type: "spell",
    rarity: "common",
    class: "DeathKnight",
    spellEffect: {
  ...
  {
    id: 3022,
    name: "Niflheim's Breath",
    manaCost: 3,
    description: "Freeze an enemy and all adjacent minions.",
    flavorText: "The wind from the lowest realm carries cold no fire can answer.",
    type: "spell",
    rarity: "common",
    class: "DeathKnight",
    spellEffect: {
  ...
  },
  {
    ...
    flavorText: "Cold steel etched with the names of the unmourned dead. It cuts cleanest where the runes glow.",
    type: "weapon",
    rarity: "common",
    class: "DeathKnight",
    collectible: true,
  ...
  },
  {
    ...
    flavorText: "The rime grip of Niflheim. What it touches, even time forgets to thaw.",
    type: "spell",
    rarity: "common",
    class: "DeathKnight",
    spellEffect: {
  ...
  {
    id: 3027,
    name: "Helthegn Initiate",
    manaCost: 2,
    attack: 2,
    health: 3,
    description: "Battlecry: Give your weapon +1/+1.",
    flavorText: "Sworn at the gates of Helheim, blade quenched in the river Gjöll.",
    type: "minion",
    rarity: "common",
    class: "DeathKnight",
    keywords: ["battlecry"],
  ...
  },
  {
    ...
    flavorText: "One of countless bones strewn along the road to Hel. Each one rises when the hornblast calls.",
    type: "minion",
    rarity: "common",
    class: "DeathKnight",
    collectible: false,
  ...
  {
    id: 3037,
    name: "Hel-Valkyr Shadowguard",
    manaCost: 5,
    attack: 4,
    health: 5,
    description: "Deathrattle: Resummon this minion with 1 Health.",
    flavorText: "The shadow-valkyries do not choose the slain — they refuse to become them.",
    type: "minion",
    rarity: "epic",
    class: "DeathKnight",
    keywords: ["deathrattle"],
  ...
  },
  {
    ...
    flavorText: "The blade cuts deeper than flesh — it severs the thread the Norns spun for that life.",
    type: "spell",
    rarity: "rare",
    class: "DeathKnight",
    spellEffect: {
  ...
  },
  {
    ...
    flavorText: "She was a seeress once. The cold changed her mind about mercy.",
    type: "minion",
    rarity: "rare",
    class: "DeathKnight",
    race: "Undead",
  ...
  },
  {
    ...
    flavorText: "The hand of Hel reaches across realms. What it touches, she claims.",
    type: "spell",
    rarity: "common",
    class: "DeathKnight",
    spellEffect: {
  ...
  },
  {
    ...
    flavorText: "The gate at the river of the dead. What you call across, you may not recognize when it returns.",
    type: "spell",
    rarity: "rare",
    class: "DeathKnight",
    spellEffect: {
