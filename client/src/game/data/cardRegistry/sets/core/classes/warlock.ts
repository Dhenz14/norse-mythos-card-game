...
export const warlockCards: CardData[] = [
  {
    ...
    health: 3,
    description: "Taunt",
    flavorText: "It walks the emptiness between realms. It has forgotten what light looks like.",
    type: "minion",
    rarity: "common",
    class: "Warlock",
    race: "Titan",
  ...
  },
  {
    ...
    flavorText: "It consumes its neighbors and grows fat on their absence.",
    type: "minion",
    rarity: "rare",
    class: "Warlock",
    race: "Titan",
  ...
  },
  {
    ...
    flavorText: "Everything returns to the void eventually. This spell accelerates the schedule.",
    type: "spell",
    rarity: "epic",
    class: "Warlock",
    spellEffect: {
  ...
  },
  {
    ...
    flavorText: "Sacrifice the servant. Heal the master. The arrangement is ancient.",
    type: "spell",
    rarity: "common",
    class: "Warlock",
    spellEffect: {
