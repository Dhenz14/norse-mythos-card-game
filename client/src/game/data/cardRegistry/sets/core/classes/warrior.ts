...
export const warriorCards: CardData[] = [
  {
    ...
    flavorText: "Forged from a coal of Surtr's own breath. The haft burns the unworthy who dare grip it.",
    type: "weapon",
    rarity: "common",
    class: "Warrior",
    collectible: true,
  ...
  },
  {
    ...
    flavorText: "Hel's overseers test your wounds before judging you worthy. Bleed for them, and they will let you stand.",
    type: "minion",
    rarity: "common",
    class: "Warrior",
    keywords: ["battlecry"],
  ...
  },
  {
    ...
    flavorText: "In the deep forges of Svartalfheim, the dwarves shape steel that has known the touch of dragonfire.",
    type: "minion",
    rarity: "common",
    class: "Warrior",
    keywords: ["battlecry"],
  ...
  },
  {
    ...
    flavorText: "The taste of his own blood drives him deeper into the rage. The deeper the cut, the harder he swings.",
    type: "minion",
    rarity: "common",
    class: "Warrior",
    collectible: true,
  ...
  },
  {
    ...
    flavorText: "In the holmgang ring, the first blow decides who walks home with both their hands.",
    type: "spell",
    rarity: "common",
    class: "Warrior",
    spellEffect: {
  ...
  },
  {
    ...
    flavorText: "When the einherjar gather in Valhalla's hall, every wound from the day's battle reopens — and they laugh through it.",
    type: "spell",
    rarity: "rare",
    class: "Warrior",
    collectible: true,
  ...
  },
  {
    ...
    flavorText: "The skald who survives the shieldwall is the one who knows when to step back and watch.",
    type: "spell",
    rarity: "common",
    class: "Warrior",
    collectible: true,
