...
export const warriorCards: CardData[] = [
  ...
  },
  {
    ...
    flavorText: "The Warsong Commander went through a lot of changes in her life, but she's now comfortable in her final form.",
    type: "minion",
    rarity: "common",
    class: "Warrior",
    aura: {
  ...
  },
  {
    ...
    health: 3,
    description: "Charge",
    flavorText: "The Kor'kron are the elite forces of Kratos Battleborn.",
    type: "minion",
    rarity: "common",
    class: "Warrior",
    keywords: ["charge"],
  ...
  },
  {
    ...
    flavorText: "The one-handed god of war sacrificed everything for victory.",
    keywords: ["charge"],
    class: "Warrior",
    collectible: true,
    set: "core"
  },
  {
    ...
    flavorText: "The divine smith forges weapons worthy of the gods.",
    keywords: ["battlecry"],
    class: "Warrior",
    collectible: true,
    set: "core",
  ...
  },
  {
    ...
    flavorText: "Forged in the depths of Blackrock Mountain.",
