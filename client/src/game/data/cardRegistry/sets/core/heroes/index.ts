...
const shamanHeroes: CardData[] = [
  {
    id: 90070,
    name: 'Thor, Lord of Thunder',
    description: 'Hero Power: Totemic Call - Summon a random Basic Totem.',
    flavorText: 'When Mjölnir leaves his hand, mountains crack and the jötnar of Jotunheim flee. The hammer always returns.',
    type: 'hero',
    rarity: 'rare',
    manaCost: 0,
    health: 100,
  ...
  {
    id: 90072,
    name: 'Volsung the Ancestor-Caller',
    description: 'Hero Power: Totemic Call - Summon a random Basic Totem.',
    flavorText: 'Patriarch of the Volsung line, who summoned the spirits of fallen kin to fight at his side.',
    type: 'hero',
    rarity: 'rare',
    manaCost: 0,
    health: 100,
  ...
  {
    id: 90074,
    name: 'Hyndla, Mistress of the Elements',
    description: 'Hero Power: Totemic Call - Summon a random Basic Totem.',
    flavorText: 'Seeress of Hyndluljóð who taught the lineage of gods and the secret names of the four winds.',
    type: 'hero',
    rarity: 'rare',
    manaCost: 0,
    health: 100,
...
const rogueHeroes: CardData[] = [
  ...
  {
    id: 90083,
    name: 'Hervör Wolf-Daughter',
    description: 'Hero Power: Dagger Mastery - Equip a 1/2 Dagger.',
    flavorText: 'Heir to the cursed sword Tyrfing, raised among shieldmaidens and skilled in the silent kill.',
    type: 'hero',
    rarity: 'rare',
    manaCost: 0,
    health: 100,
  ...
  {
    id: 90084,
    name: 'Ölmod the Quick-Fingered',
    description: 'Hero Power: Dagger Mastery - Equip a 1/2 Dagger.',
    flavorText: 'A shadow-walker of Svartalfheim whose blades found gaps in any forge-mark.',
    type: 'hero',
    rarity: 'rare',
    manaCost: 0,
    health: 100,
  ...
  },
  {
    ...
    name: 'Eric Bloodaxe',
    description: 'Hero Power: Dagger Mastery - Equip a 1/2 Dagger.',
    flavorText: 'Sea-king of the Norse, last to rule York. His longship struck terror from Iceland to the Hebrides.',
    type: 'hero',
    rarity: 'rare',
    manaCost: 0,
    health: 100,
...
const berserkerHeroes: CardData[] = [
  ...
  {
    id: 90091,
    name: 'Sváfnir the Flame-Exile',
    description: 'Hero Power: Berserker Claws - Gain +1 Attack this turn.',
    flavorText: 'Cast out from Muspelheim for refusing Surtr, he wields the fire that once spurned him.',
    type: 'hero',
    rarity: 'rare',
    manaCost: 0,
    health: 100,
  ...
  {
    id: 90092,
    name: 'Hadingus the Ash-Born',
    description: 'Hero Power: Berserker Claws - Gain +1 Attack this turn.',
    flavorText: 'Sole survivor of his clan after the jötnar burned Hadingsey, sworn to drag every giant down to Hel.',
    type: 'hero',
    rarity: 'rare',
    manaCost: 0,
    health: 100,
