...
const mageHeroes: CardData[] = [
  ...
  },
  {
    ...
    description: 'Hero Power: Fireblast - Deal 1 damage.',
    flavorText: 'A fire mage known for his pyroblast skills and fiery personality.',
    type: 'hero',
    rarity: 'legendary',
    manaCost: 0,
    health: 30,
...
const hunterHeroes: CardData[] = [
  ...
  },
  {
    ...
    description: 'Hero Power: Aimed Shot - Deal 2 damage to the enemy hero.',
    flavorText: 'Legendary big game hunter and safari guide.',
    type: 'hero',
    rarity: 'legendary',
    manaCost: 0,
    health: 30,
...
const warlockHeroes: CardData[] = [
  ...
  },
  {
    ...
    name: 'Mecha-Jaraxxus',
    description: 'Hero Power: Life Tap - Draw a card and take 2 damage.',
    flavorText: 'A mechanized demon lord of immense dark power.',
    type: 'hero',
    rarity: 'legendary',
    manaCost: 0,
    health: 30,
...
const deathKnightHeroes: CardData[] = [
  ...
  {
    id: 90102,
    name: 'Thanatos Soulreaper',
    description: "Hero Power: Death's Touch - Deal 1 damage to a minion and raise a 1/1 Ghoul if it dies.",
    flavorText: 'The personification of death who guides souls to the underworld.',
    type: 'hero',
    rarity: 'legendary',
    manaCost: 0,
    health: 30,
  ...
  },
  {
    ...
    description: "Hero Power: Death's Touch - Deal 1 damage to a minion and raise a 1/1 Ghoul if it dies.",
    flavorText: 'Former elven ranger transformed into a Death Knight by the Lich Lord.',
    type: 'hero',
    rarity: 'legendary',
    manaCost: 0,
    health: 30,
  ...
  },
  {
    ...
    name: 'Lady Alistra',
    description: "Hero Power: Death's Touch - Deal 1 damage to a minion and raise a 1/1 Ghoul if it dies.",
    flavorText: 'Master of unholy magics and instructor of aspiring Death Knights.',
    type: 'hero',
    rarity: 'legendary',
    manaCost: 0,
    health: 30,
  ...
  },
  {
    ...
    description: "Hero Power: Death's Touch - Deal 1 damage to a minion and raise a 1/1 Ghoul if it dies.",
    flavorText: 'Death Knight known for his mastery over undead steeds.',
    type: 'hero',
    rarity: 'legendary',
    manaCost: 0,
    health: 30,
