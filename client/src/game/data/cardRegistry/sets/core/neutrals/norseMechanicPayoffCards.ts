...
export const bloodPricePayoffCards: CardData[] = [
	{
		...
		flavorText: 'She laps at the wounds of sacrifice and grows fat on suffering.',
		type: 'minion',
		rarity: 'rare',
		class: 'Warlock',
		set: 'core',
	...
	},
	{
		...
		flavorText: 'Carved in blood, the rune glows with borrowed vitality.',
		type: 'spell',
		rarity: 'rare',
		class: 'Mage',
		spellEffect: {
...
export const prophecyPayoffCards: CardData[] = [
	...
	},
	{
		...
		flavorText: 'She reads the moment fate snaps taut and drinks deep of its meaning.',
		type: 'minion',
		rarity: 'epic',
		class: 'Warlock',
		set: 'core',
...
export const realmShiftPayoffCards: CardData[] = [
	{
		id: 31914,
		name: 'Wanderer of the Nine',
		manaCost: 3,
		attack: 2,
		health: 4,
		description: 'Gains +2/+1 whenever the active realm changes. Cannot be frozen.',
		flavorText: 'He has walked every realm and calls none of them home.',
		type: 'minion',
		rarity: 'rare',
		class: 'Shaman',
		set: 'core',
...
export const norseTechCards: CardData[] = [
	{
		...
		attack: 3,
		health: 3,
		description: "Battlecry: Destroy your opponent's weapon or artifact.",
		flavorText: 'The master dwarf who forged Mjolnir knows exactly where to strike to shatter any creation.',
		type: 'minion',
		rarity: 'rare',
		class: 'Neutral',
		keywords: ['battlecry'],
