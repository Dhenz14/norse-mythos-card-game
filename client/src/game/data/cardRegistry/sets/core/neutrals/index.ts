...
const legendaryNeutralMinions: CardData[] = [
  ...
  },
  {
    ...
    flavorText: 'When Mjölnir leaves his hand, lightning splits Midgard. The mountains tremble; the jötnar kneel.',
    keywords: ['battlecry'],
    class: 'Neutral',
    collectible: true,
    set: 'core',
...
const mythologyNorseCards: CardData[] = [
  ...
  {
    id: 32097,
    name: 'Jotunn Lord of Helheim',
    manaCost: 9,
    attack: 9,
    health: 7,
    type: 'minion',
    rarity: 'rare',
    description: 'Your other Jotnar have +2/+2. Your hero is Immune.',
...
const cheatRecruitRampCards: CardData[] = [
  ...
  {
    id: 33269,
    name: 'Helcaller of Niflheim',
    description: 'Deathrattle: Put a random Jotunn from your hand into the battlefield.',
