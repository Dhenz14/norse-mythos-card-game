...
export const primordialExpansionCards: CardData[] = [
...

	{
		...
		class: 'neutral',
		race: 'Beast',
		description: 'Battlecry: Submerge for 1 turn. Surface: Gain +3/+3.',
		keywords: ['battlecry'],
		battlecry: { type: 'submerge', value: 1, surfaceEffect: 'buff_self', buffAttack: 3, buffHealth: 3 },
		collectible: true,
		flavorText: 'It vanishes beneath the waves and returns twice as fearsome.',
	},
	{
		id: 40105,
		name: 'Deep Lurker',
		...
		class: 'neutral',
		race: 'Naga',
		description: 'Battlecry: Submerge for 2 turns. Surface: Deal 4 damage to a random enemy.',
		keywords: ['battlecry'],
		battlecry: { type: 'submerge', value: 2, surfaceEffect: 'damage_random', surfaceDamage: 4 },
		collectible: true,
		flavorText: 'Patience is the predator\'s greatest weapon. Two tides, and it strikes.',
	},
	{
		id: 40106,
	...
	},
	{
		...
		class: 'neutral',
		race: 'Naga',
		description: 'Battlecry: Submerge for 1 turn. Surface: Deal 3 damage to all enemies.',
		keywords: ['battlecry'],
		battlecry: { type: 'submerge', value: 1, surfaceEffect: 'damage_all_enemies', surfaceDamage: 3 },
		collectible: true,
		flavorText: 'The tide brings destruction. The undertow brings silence.',
	},
	{
		id: 40109,
