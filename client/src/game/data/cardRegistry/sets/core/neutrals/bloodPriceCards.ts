...
export const bloodPriceCards: CardData[] = [
	...
	},
	{
		...
		name: "Norn's Bargain",
		manaCost: 4,
		description: 'Restore 6 Health to all friendly minions.',
		flavorText: 'The Norns weave fate with threads of sacrifice and salvation.',
		type: 'spell',
		rarity: 'rare',
		class: 'Priest',
		keywords: ['blood_price'],
	...
	{
		id: 30007,
		name: "Einherjar's Price",
		manaCost: 6,
		attack: 6,
		health: 6,
		description: 'Taunt. Battlecry: If paid with Blood Price, summon a copy.',
		flavorText: 'Those who pay with their own blood earn the right to stand beside the gods.',
		type: 'minion',
		rarity: 'epic',
		class: 'Neutral',
