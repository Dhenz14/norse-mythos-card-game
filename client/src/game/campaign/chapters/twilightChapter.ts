...
export const twilightChapter: CampaignChapter = {
	...
	missions: [
		...
		// Vidar avenges his father. Surtr burns the world.
		{
			...
			narrativeBefore: 'The horn of Heimdall sounds across all Nine Realms. The gods march out of Asgard for the last time. Across the rainbow bridge they cross to the field of Vigrid, where they will meet the army of the giants and the army of the dead and the burning host of Muspelheim. Thor will go to find Jormungandr. Heimdall will go to find Loki. Odin will go to find Fenrir. Frey will go to meet Surtr the fire-giant, and remember too late that he traded his sword away for a giant girl. Tyr the one-handed will meet Garm the hellhound and they will kill each other. Vidar, the silent god, will be standing very close to his father at the moment Fenrir\u2019s jaws open. The cosmos will burn. And then \u2014 if any of you do this well enough \u2014 the cosmos will start again, green from the sea, and Baldr will walk out of Hel\u2019s hall with light in his face, and two humans named Lif and Lifthrasir will wake in a grove the fire never reached. You stand on Vigrid in armor heavy enough to remember every dead friend you brought with you. The horn is still sounding. Pick your duel.',
