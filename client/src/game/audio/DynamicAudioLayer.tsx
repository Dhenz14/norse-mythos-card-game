...
const DynamicAudioLayer: React.FC = () => {
  ...
  const calculateGameIntensity = () => {
    ...
    const playerHero = gameState.players.player.hero;
    const playerHealth = playerHero?.health || 30; // Default to 30 if not available
    const playerMaxHealth = playerHero?.maxHealth || 30; // Default to 30 if not available
