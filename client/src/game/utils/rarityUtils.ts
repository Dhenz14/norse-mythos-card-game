...
export function getRarityGlow(rarity: string): string {
  switch (rarity) {
    ...
    case 'legendary': return 'shadow-[0_0_60px_rgba(251,191,36,1)]';
...
export function getRarityBackground(rarity: string): string {
  switch (rarity) {
    ...
    case 'legendary': return 'bg-gradient-to-br from-amber-700 to-amber-900';
...
export function getRarityBgColor(rarity: string): string {
  switch (rarity) {
    ...
    case 'legendary': return 'bg-amber-600/30';
