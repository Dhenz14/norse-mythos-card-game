...
export function executeSummonJadeGolemSummonJadeGolem(
  ...
  console.log(`Executing summon_jade_golem battlecry for ${sourceCard.card.name}`);
  

  
  // TODO: Implement the summon_jade_golem battlecry effect
  ...
  newState.gameLog.push({
    ...
    type: 'battlecry',
    text: `${sourceCard.card.name} triggered summon_jade_golem battlecry`,
    timestamp: Date.now(),
