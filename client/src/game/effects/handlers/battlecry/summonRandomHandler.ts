...
export function executeSummonRandomSummonRandom(
  ...
  console.log(`Executing summon_random battlecry for ${sourceCard.card.name}`);
  ...
  // TODO: Implement the summon_random battlecry effect
  ...
  newState.gameLog.push({
    ...
    type: 'battlecry',
    text: `${sourceCard.card.name} triggered summon_random battlecry`,
    timestamp: Date.now(),
