...
const BaseCardFrame: React.FC<CardBaseProps> = ({
  ...
  const rarityColors = {
    basic: '#8c8c8c',  // gray
    common: '#b0b0b0', // light gray
    rare: '#0070dd',   // blue
    epic: '#a335ee',   // purple
    mythic: '#ff8000'  // orange/gold
  };
  ...
  const getCardGlow = () => {
    ...
    if (rarity === 'mythic') return '0 0 15px rgba(255, 176, 0, 0.7)';
  ...
  return (
    <div 
      ...
      style={{
        ...
        borderRadius: '12px',
        backgroundColor: rarity === 'mythic' ? '#2a1a00' : 
                       rarity === 'epic' ? '#2a0a2a' : 
    ...
    >
      ...
      <div 
        className={`card-inner ${
          rarity === 'mythic' 
            ? 'mythic-card holographic-enabled' 
            : rarity === 'epic' 
