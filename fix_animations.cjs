...
// Handle the fallback values
content = content.replace(/animation\.position\?\.x/g, 'animation.position?.x || 0');
content = content.replace(/animation\.position\?\.y/g, 'animation.position?.y || 0');
content = content.replace(/animation\.targetPosition\?\.x/g, 'animation.targetPosition?.x || 0');
content = content.replace(/animation\.targetPosition\?\.y/g, 'animation.targetPosition?.y || 0');
