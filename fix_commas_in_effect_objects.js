/**
 * A specialized script to fix incorrect commas in effect objects.
 * This script will fix issues where effect properties have commas after the opening brace
 * or where trailing commas should be removed/added as appropriate.
 */
